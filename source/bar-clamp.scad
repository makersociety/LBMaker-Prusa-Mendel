...
module barclamp(){
outer_diameter = (threaded_rod_diameter)/2+2.3;
//outer_diameter = (threaded_rod_diameter)/2+2.7;
...
difference(){
	union(){
		...
		translate([18, 2*outer_diameter, outer_diameter])rotate([90, 90, 0]) rotate([00, , 0]) nut(outer_diameter*2,outer_diameter*2,false);
	}
