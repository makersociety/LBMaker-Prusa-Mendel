...
// Note Ben Cannon
// Changing the value here in the motor mount translation array
// will move the motor mount 
// Other note: Bumping out the distance of the motor mount to align it with Idler
// is leaving a growing gap between the base of mount and the X end.
// More mass may need to added. Time will tell....
// Also the bridge_shear value should be changed to align the bridge support correctly
motor_mount_translation=[44-thickness+3.5,8,23.5-4.7-12+24.5];
...
module positioned_motor_mount()
{
	...
	// Ben Cannon 
	//Note: Moving out motor mount translation creates a gap between motor mount
	// and x-end base. Editing the x value in the cube below will close or open the gap
	#cube([18,nema17_width+2,20]);
